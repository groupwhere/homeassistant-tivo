...
So far, this code has a framework that is not fully implemented.  It should load if copied to your CONFIG_DIR/custom_components/media_player directory.  It requires the following configuration:
